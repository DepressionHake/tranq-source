...
//logs listener
class IGameEventListener3
{
public:
	virtual	~IGameEventListener3() {};
...
class DamageEventListener : public IGameEventListener3
{
public:
...
public:
	...
	virtual bool AddListener(IGameEventListener3* listener, const char *name, bool bServerSide) = 0;
	virtual bool FindListener(IGameEventListener3* listener, const char *name) = 0;
	virtual int RemoveListener(IGameEventListener3* listener) = 0;
