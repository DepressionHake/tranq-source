...
{
public:
	virtual bool            ShouldHitEntity(IClientEntity* m_entity, int contentsMask) = 0;
...
{
public:
	bool ShouldHitEntity(IClientEntity* m_entityHandle, int contentsMask)
	{
		return !(m_entityHandle == pSkip);
	}
...
{
public:
	int	GetPointContents(const Vector &vecAbsPosition, int contentsMask = MASK_ALL, IClientEntity** pm_entity = NULL)
	{
		typedef int(__thiscall* fnGetPointContents)(void*, const Vector&, int, IClientEntity**);
		return call_vfunc<fnGetPointContents>(this, 0)(this, vecAbsPosition, contentsMask, pm_entity);
	}
	...
	void TraceRay2(const Ray_t &ray, unsigned int fMask, ITraceFilter* pTraceFilter, trace_t1* pTrace)
	{
		typedef void(__thiscall* fnTraceRay)(void*, const Ray_t&, unsigned int, ITraceFilter*, trace_t1*);
		call_vfunc<fnTraceRay>(this, 5)(this, ray, fMask, pTraceFilter, pTrace);
	}

	virtual void	TraceRay2(const Ray_t &ray, unsigned int fMask, ITraceFilter *pTraceFilter, trace_t *pTrace) = 0;
...
public:
    ...
    {
        typedef void(thiscall* OriginalFn)(void*, bool);
        return call_vfunc<OriginalFn>(this, 11)(this, bEnable);
    }

    void ResetInputState()
    {
        typedef void(thiscall* OriginalFn)(void*);
...
public:
	...
	virtual void	DrawBeam(C_Beam* pbeam, ITraceFilter *m_entityBeamTraceFilter = NULL) = 0;
